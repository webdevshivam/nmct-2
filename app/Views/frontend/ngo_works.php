    ...
    <div class="container">
        <div class="row align-items-center min-vh-100 py-5">
            <div class="col-lg-8 mx-auto text-center">
                <div class="mb-4">
                    <span class="badge bg-primary-light text-primary px-4 py-2 rounded-pill fs-6 mb-3">Our Comprehensive Approach</span>
                    <h1 class="display-3 fw-bold mb-4 text-gradient">Beyond Financial Aid</h1>
                    <p class="lead fs-4 mb-5">We don't just provide monetary support. We create professionals through education, mentoring, and career development - real empowerment at the ground level to uplift society.</p>
                </div>
                ...
                <div class="row g-4 mb-5">
                    <div class="col-md-4">
                        ...
                        <h4 class="fw-bold mb-2">Quality Education</h4>
                        <p class="text-muted">Comprehensive academic support with modern learning methodologies</p>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-icon mx-auto mb-3" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);">
                            <i class="fas fa-users"></i>
                        </div>
                        <h4 class="fw-bold mb-2">Personal Mentoring</h4>
                        <p class="text-muted">One-on-one guidance from industry professionals and experts</p>
                    </div>
                    <div class="col-md-4">
                        <div class="feature-icon mx-auto mb-3" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);">
                            <i class="fas fa-briefcase"></i>
                        </div>
                        <h4 class="fw-bold mb-2">Career Development</h4>
                        <p class="text-muted">Professional training and employment assistance for sustainable futures</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 mb-5 mb-lg-0">
                <span class="badge bg-primary-light text-primary px-3 py-2 rounded-pill mb-3">Our Philosophy</span>
                <h2 class="section-title font-display mb-4">Real Empowerment, Not Just Aid</h2>
                <p class="lead mb-4">Most NGOs in the education sector only offer monetary help. We go beyond - we create professionals.</p>
                ...
                <div class="empowerment-features">
                    <div class="d-flex align-items-start mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted mb-0">We focus on intellectual, emotional, and professional growth of every individual.</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start mb-4">
                        ...
                        <div>
                            <h5 class="fw-bold mb-2">Industry Connections</h5>
                            <p class="text-muted mb-0">Direct partnerships with companies and professionals for real-world exposure.</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <h5 class="fw-bold mb-2">Sustainable Impact</h5>
                            <p class="text-muted mb-0">Creating self-reliant professionals who can contribute back to society.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6">
                            <div class="stat-card text-center p-4 rounded-4" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); color: white;">
                                ...
                                <div class="stat-label">Years of Mentoring</div>
                            </div>
                        </div>
                        <div class="col-6">
...
<section class="section-padding">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <span class="badge bg-primary-light text-primary px-3 py-2 rounded-pill mb-3">Comprehensive Programs</span>
                <h2 class="section-title font-display mb-4">Education + Mentoring + Employment</h2>
                <p class="lead text-muted">The first of its kind comprehensive approach that transforms students into industry-ready professionals</p>
            </div>
        </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <ul class="list-unstyled mb-4">
                            <li class="mb-3 d-flex align-items-center">
                                ...
                                <span>Full academic fee coverage</span>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                                <i class="fas fa-check-circle me-3"></i>
                                <span>Modern learning resources</span>
                            </li>
                            <li class="mb-3 d-flex align-items-center">
                                <i class="fas fa-check-circle me-3"></i>
                            ...
                            <li class="mb-3 d-flex align-items-center">
                                <i class="fas fa-check-circle me-3"></i>
                                <span>Language proficiency training</span>
                            </li>
                        </ul>
                        <div class="program-outcome">
                            <small class="opacity-75">Outcome: Strong Academic Foundation</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="program-card h-100 border-0 shadow-lg" style="background: linear-gradient(145deg, #f093fb 0%, #f5576c 100%); color: white; border-radius: 20px;">
                    <div class="card-body p-5">
                        ...
                        <div class="program-outcome">
                            <small class="opacity-75">Outcome: Industry-Ready Mindset</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="program-card h-100 border-0 shadow-lg" style="background: linear-gradient(145deg, #4facfe 0%, #00f2fe 100%); color: white; border-radius: 20px;">
                    <div class="card-body p-5">
                        ...
                        <h3 class="card-title font-display mb-4">Employment Support</h3>
                        <ul class="list-unstyled mb-4">
                            <li class="mb-3 d-flex align-items-center">
                                <i class="fas fa-check-circle me-3"></i>
                        ...
                        <div class="program-outcome">
                            <small class="opacity-75">Outcome: Sustainable Employment</small>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-padding bg-soft">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <span class="badge bg-primary-light text-primary px-3 py-2 rounded-pill mb-3">Success Journey</span>
                <h2 class="section-title font-display mb-4">From Student to Professional</h2>
                <p class="lead text-muted">Follow the journey of our beneficiaries as they transform into industry professionals</p>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="journey-step text-center">
                        ...
                        <p class="text-muted">Strong educational foundation with modern learning approaches</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="journey-step text-center">
                        ...
                        <h5 class="fw-bold mb-3">Skill Development</h5>
                        <p class="text-muted">Industry-relevant skills through practical workshops and training</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="journey-step text-center">
                        ...
                        <h5 class="fw-bold mb-3">Professional Readiness</h5>
                        <p class="text-muted">Interview skills, communication, and workplace etiquette training</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="journey-step text-center">
                        ...
                        <h5 class="fw-bold mb-3">Career Launch</h5>
                        <p class="text-muted">Job placement and ongoing professional support</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="section-padding">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-8 mx-auto text-center">
                <span class="badge bg-primary-light text-primary px-3 py-2 rounded-pill mb-3">Our Impact</span>
                <h2 class="section-title font-display mb-4">Real Stories, Real Transformation</h2>
                <p class="lead text-muted">See how we're creating professionals, not just providing aid</p>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-6 mx-auto">
                <select class="form-select form-select-lg" id="categoryFilter">
                    ...
                    <option value="Community Service">Community Development</option>
                    ...
                    <div class="card h-100 border-0 shadow-lg work-card">
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <span class="badge bg-primary px-3 py-2"><?= esc($work['category']) ?></span>
                                <?php if (!empty($work['beneficiaries_count'])): ?>
                                    <small class="text-muted">
                                        <i class="fas fa-users me-1"></i> <?= number_format($work['beneficiaries_count']) ?> beneficiaries
                                    </small>
                                <?php endif; ?>
                            </div>
                            
                            <h5 class="card-title font-display mb-3"><?= esc($work['title']) ?></h5>
                            <p class="card-text text-muted mb-3"><?= esc(character_limiter($work['description'], 100)) ?></p>
                            
                            <div class="work-details">
                                <?php if (!empty($work['location'])): ?>
                                    <div class="detail-item mb-2">
                                        <i class="fas fa-map-marker-alt text-primary me-2"></i>
                                        <span class="text-muted"><?= esc($work['location']) ?></span>
                                    </div>
                                <?php endif; ?>
...
<section class="section-padding">
    <div class="container">
        <div class="text-center py-5">
            ...
            <h4 class="mb-3">Our Transformation Stories Coming Soon</h4>
            <p class="lead text-muted mb-4">We're documenting our comprehensive approach to student empowerment. Check back soon to see real stories of education, mentoring, and career success.</p>
            <a href="<?= base_url('beneficiaries') ?>" class="btn btn-primary btn-lg">
                <i class="fas fa-users me-2"></i> Meet Our Current Beneficiaries
            </a>
        </div>
    </div>
</section>
    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead mb-5 fs-4">Be part of the first NGO that creates professionals, not just provides aid. Help us empower the next generation with education, mentoring, and career opportunities.</p>
                
                <div class="row justify-content-center g-3">
                    <div class="col-md-4">
                        <a href="<?= base_url('beneficiaries') ?>" class="btn btn-light btn-lg w-100 py-3">
                            <i class="fas fa-graduation-cap me-2"></i> Support Education
                        </a>
                    </div>
                    <div class="col-md-4">
